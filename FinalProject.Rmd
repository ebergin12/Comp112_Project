...
TidyPitchData %>%
  ...
  geom_text(aes(label = str_c(pitch_percent, Pitch_Type, sep = "\n")), 
            ...
            fontface = "bold",
            nudge_x = .5) + 
  labs(title = "Zack Greinke 2019 Season Pitch Frequency by Pitch Type", 
       x = "Frequency (%)", 
       y = "") + 
...
TidyPitchData %>%
  ...
  geom_text(aes(x = avg_speed, y = Pitch_Type, label = mph_speed), 
            ...
            fontface = "bold",
            nudge_x = .5) +
  labs(title = "Zack Greinke 2019 Season Average Pitch Speed by Pitch Type", 
       x = "Pitch Speed (mph)",
       y = NULL) + 
...
TidyPitchData %>% 
  ...
  labs(shape = "Pitch Type", 
       ...
       title = "Zack Greinke 2019 Season Average Pitch Movement by Pitch Type",
