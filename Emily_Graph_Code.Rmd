...
TidyPitchData <- bind_rows(FFData2016, SliderData2016, ChangeData2016, CurveData2016, SinkerData2016, CutterData2016)
```


```{r}
TidyPitchData %>%
  ggplot(aes(x = pitch_frequency, y = Pitch_Type)) +
  geom_col() +
